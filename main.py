...
# Black Magic Spells (name, cost, damage, kind)
...
# Player and Enemy Abilities and Items
...
# Instantiate People stats (name, health, magic, attack, defence, magic, items)
...
# Make sure user input will not generate error
def input_num(self):
    while True:
        try:
...
# Script allowing attack of and from enemy
running = True
i = 0
...
while running:
    ...
    # Player attacks
    for player in players:
        # Player chooses attack, magic, or item
        player.choose_action()
        choice = input_num("    Choose action:")
        # Make choice numbering start at 1  since index begins at 0
        index = int(choice) - 1

        # Avoid unavailable choice input
        ...
        # Use Magic
            ...
            # Determine if enough mp to cast
